...
final class ResourceClient[
  ...
  def getAll(
    ...
    ZStream.unwrap {
      handleFailures("getAll", namespace) {
        k8sRequest
          .get(
            paginated(
              namespace,
            ...
            pull               = for {
                                   ...
                                   chunk         <- continueToken match {
                                                      ...
                                                      case Optional.Present(token)                =>
                                                        for {
                                                          lst <- handleFailures("getAll", namespace) {
                                                                   k8sRequest
                                                                     .get(
                                                                       paginated(
                                                                         namespace,
  ...
  private def watchStream(
    ...
    val reqInfo = K8sRequestInfo(resourceType, "watch", namespace)
    ZStream
      .unwrap {
        handleFailures("watch", namespace) {
          k8sRequest
  ...
  override def create(
    ...
    handleFailures("create", namespace) {
      k8sRequest
  ...
  override def replace(
    ...
    handleFailures("replace", namespace) {
      k8sRequest
  ...
  override def delete(
    ...
    handleFailures("delete", namespace) {
      k8sRequest
        .delete(
          deleting(
            name = name,
  ...
  def deleteAll(
    ...
    handleFailures("deleteAll", namespace) {
      k8sRequest
        .delete(
          deletingMany(
            namespace,
