...
const siteConfig = {
  title: 'ZIO K8s',
  tagline: 'An idiomatic ZIO client for the Kubernetes API.',
  url: 'https://coralogix.github.io',
  baseUrl: '/zio-k8s/', 

  projectName: 'zio-k8s',
  organizationName: 'coralogix',
  ...
  headerLinks: [
    ...
    {href: '/zio-k8s/api/com/coralogix/zio/k8s/index.html', label: 'API'},
  ...
  */
  ...
  customDocsPath: 'zio-k8s-docs/target/mdoc',
