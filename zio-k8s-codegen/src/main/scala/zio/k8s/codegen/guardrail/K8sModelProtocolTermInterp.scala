...
class K8sModelProtocolTermInterp(implicit
  ...
  override def renderDTOClass(
    ...
    val baseObjectType = t"zio.k8s.client.model.Object"
                    ...
                    .traverse({
                      case (param, idx) =>
                        for {
                          ...
                          val emptyToNull: Term => Term = if (param.emptyToNull == EmptyIsNull) {
                            t =>
  ...
  override def renderDTOStaticDefns(
    ...
    circe
      ...
      .map(sdefs =>
        sdefs.copy(
          extraImports =
            q"import zio.k8s.client.model.Object" ::
              q"import zio.k8s.client.model.primitives._" ::
              sdefs.extraImports
        )
      )
}
